...
import 'package:mobx_aula_01/serializers/news.dart';
import 'package:mobx_aula_01/serializers/news_list.dart';
import 'package:mobx_aula_01/utils/constants.dart';
...
Future<NewsList> fetchNewsList() async {
  final response = await http.get(NewsConstants.newsListUrl);
...
Future<News> fetchNews(int newsId) async {
  String url = NewsConstants.newsUrl(newsId);
  print(url);
